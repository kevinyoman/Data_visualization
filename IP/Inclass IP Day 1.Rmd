...
vids <- read_csv("data_input/youtubetrends.csv",locale = locale(encoding))
...
# Please type your code here
plot1 <- 
ggplot(data=vids_count,mapping=aes(x=counts,y=reorder(category_id,counts)))+
  geom_col(mapping=aes(fill=counts))+
...
# group =1, untuk menunjukkan 1 geom_line saja.
```
